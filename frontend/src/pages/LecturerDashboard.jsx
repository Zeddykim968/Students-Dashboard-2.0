...
import { Users, LayoutGrid, UserCog } from 'lucide-react'
    ...
    <div>
      ...
      {groups.length === 0 && (
        <div className="text-center py-20">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">No groups</h3>
          <p className="text-gray-500">Create groups to manage classes.</p>
        </div>
      )}
    </div>
  )
